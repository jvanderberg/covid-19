...
df_7day['positiveIncrease'] = 1000000 * df_7day['positiveIncrease'] / df_7day['population']
df_7day['deathIncrease'] = 1000000 * df_7day['deathIncrease'] / df_7day['population']
df_7day['totalTestResultsIncrease'] = 1000000 * df_7day['totalTestResultsIncrease'] / df_7day['population']

colors = ['tab:blue', 'tab:orange', 'tab:red', 'tab:brown', 'tab:green', 'tab:purple', 'tab:gray', 'tab:cyan']
#######################################################################################
# Deaths report
#######################################################################################
...
for idx,state in enumerate(states):
    plt.plot(df.index, df_7day['deathIncrease'][state], color=colors[idx], label=state, linewidth=4)
...
plt.margins(0)
for idx,state in enumerate(states):
    plt.plot(df.index, df_7day['positiveIncrease'][state], color=colors[idx], label=state, linewidth=4)
...
plt.margins(0)
for idx,state in enumerate(states):
    plt.plot(df.index, df_7day['percentage'][state], color=colors[idx], label=state, linewidth=4)
...
for idx,state in enumerate(states):
    plt.plot(df.index, df_7day['totalTestResultsIncrease'][state], color=colors[idx], label=state, linewidth=4)
