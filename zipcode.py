...
diff['cases_per_million_14day'].tail(1).transpose().to_csv('zip_city_cases_per_million_latest.csv')
diff['percentage_14day'].tail(1).transpose().to_csv('zip_city_percentage_latest.csv')
